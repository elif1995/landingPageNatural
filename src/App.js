  ...
  return (
    <div className="app">
      ...
      <div className="queary-div">
        <h1><button  className="queary-div-button"><Link smooth={true} to="form" style={{color:'white'}}>לחצי כאן</Link ></button> אם  את מעוניינת לנסות את המוצר </h1> 
      </div>
      <PositivePoints/>
      <br/>
      <Form/>
      ...
      <div className="social-links">
        <div><a href="https://api.whatsapp.com/send?phone=0508105610&text=%D7%A9%D7%9C%D7%95%D7%9D%20%D7%90%D7%A0%D7%99%20%D7%9E%D7%A2%D7%95%D7%A0%D7%99%D7%99%D7%A0%D7%AA"><FontAwesomeIcon className="fa-3x" icon={faWhatsapp} style={{color: 'white'}}></FontAwesomeIcon></a></div>
